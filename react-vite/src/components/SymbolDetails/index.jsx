...
import { getSymbol, getSymbolPrices } from '../../redux/symbols';  // Updated import names
...
const SymbolDetails = () => {
    ...
    useEffect(() => {
        if (symbol) {
            dispatch(getSymbol(symbol));  // Updated function name
            dispatch(getSymbolPrices(symbol))  // Updated function name
